...
\addplot[solid,ch1color]table[x=time,y=ch1,col sep=comma]{tek0009ch1.csv};
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch1color}]0:{}}] at (axis cs:-5,0.06){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]\tipangleA:{CH1}}] at (axis cs:3.6005,2){}; % Print curve tip
\addlegendentry[align=center]{\varchA @ CH1\\ \SI{125}{\V}/div}

% Arrows and labels for channel ch2
\addplot[solid,ch2color]table[x=time,y=ch2,col sep=comma]{tek0009ch2.csv};
...
\addplot[solid,ch3color]table[x=time,y=ch3,col sep=comma]{tek0009ch3.csv};
...
\addplot[solid,ch4color]table[x=time,y=ch4,col sep=comma]{tek0009ch4.csv};
