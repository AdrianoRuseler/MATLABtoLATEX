%
%
\documentclass[varwidth=307pt]{standalone}
% \usepackage{tikz}
...
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]\tipangleD:{CH4}}] at (axis cs:-4.0995,3.72){}; % Print curve tip
