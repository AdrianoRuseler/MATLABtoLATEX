...
\usepackage{siunitx}
% \sisetup 
\sisetup{scientific-notation = fixed, fixed-exponent = 0, round-mode = figures,round-precision = 3}
...
\addplot[solid,ch1color]table[x=time,y=ch1,col sep=comma]{tek0009.csv}; % Add plot data
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch1color}]0:{}}] at (axis cs:-5,0.06){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]\tipangleA:{CH1}}] at (axis cs:3.5005,2){}; % Print curve tip
\addlegendentry[align=center]{\varchA @ CH1\\ \SI{125}{\V}/div}

% Arrows and labels for channel ch2
\addplot[solid,ch2color]table[x=time,y=ch2,col sep=comma]{tek0009.csv}; % Add plot data
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch2color}]0:{}}] at (axis cs:-5,0.02){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]\tipangleB:{CH2}}] at (axis cs:-0.3995,2){}; % Print curve tip
\addlegendentry[align=center]{\varchB @ CH2\\ \SI{125}{\V}/div}

% Arrows and labels for channel ch3
\addplot[solid,ch3color]table[x=time,y=ch3,col sep=comma]{tek0009.csv}; % Add plot data
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch3color}]0:{}}] at (axis cs:-5,0){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]\tipangleC:{CH3}}] at (axis cs:-2.1995,-2.04){}; % Print curve tip
\addlegendentry[align=center]{\varchC @ CH3\\ \SI{125}{\V}/div}

% Arrows and labels for channel ch4
\addplot[solid,ch4color]table[x=time,y=ch4,col sep=comma]{tek0009.csv}; % Add plot data
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch4color}]0:{}}] at (axis cs:-5,-0.98){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]\tipangleD:{CH4}}] at (axis cs:1.9005,3.88){}; % Print curve tip
\addlegendentry[align=center]{\varchD @ CH4\\ \SI{250}{\V}/div}
