...
\addplot[solid,ch1color]table[x=time,y=ch1,col sep=comma]{tek0009.csv};
\addplot[solid,ch2color]table[x=time,y=ch2,col sep=comma]{tek0009.csv};
\addplot[solid,ch3color]table[x=time,y=ch3,col sep=comma]{tek0009.csv};
\addplot[solid,ch4color]table[x=time,y=ch4,col sep=comma]{tek0009.csv};
