...
\def \varchA {$i_{A}$} % Variable at channel A (1);
\def \varchB {$i_{B}$} % Variable at channel B (2);
\def \varchC {$i_{C}$} % Variable at channel C (3);
\def \varchD {$i_{in}$} % Variable at channel D (4);
\def \varchE {$i_{E}$} % Variable at channel E (5); ...
...
\addplot[solid,ch1color]table[x=time,y=ch1,col sep=comma]{tek0001ch1.csv};
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch1color}]0:{}}] at (axis cs:-5,0.04){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]125:{CH1}}] at (axis cs:4.2972,2.0117){}; % Print curve tip
\addlegendentry[align=center]{\varchA @ CH1\\ \SI{10}{\A}/div\\ RMS: \SI{12.8}{\A}}

% Arrows and labels for channel ch2
\addplot[solid,ch2color]table[x=time,y=ch2,col sep=comma]{tek0001ch2.csv};
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch2color}]0:{}}] at (axis cs:-5,0.08){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]118:{CH2}}] at (axis cs:2.1544,2.0408){}; % Print curve tip
\addlegendentry[align=center]{\varchB @ CH2\\ \SI{10}{\A}/div\\ RMS: \SI{11.6}{\A}}

% Arrows and labels for channel ch3
\addplot[solid,ch3color]table[x=time,y=ch3,col sep=comma]{tek0001ch3.csv};
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch3color}]0:{}}] at (axis cs:-5,0){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]114:{CH3}}] at (axis cs:-1.371,1.9534){}; % Print curve tip
\addlegendentry[align=center]{\varchC @ CH3\\ \SI{10}{\A}/div\\ RMS: \SI{13.8}{\A}}

% Arrows and labels for channel ch4
\addplot[solid,ch4color]table[x=time,y=ch4,col sep=comma]{tek0001ch4.csv};
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch4color}]0:{}}] at (axis cs:-5,-4.04){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]-46:{CH4}}] at (axis cs:-2.0853,-3.1778){}; % Print curve tip
\addlegendentry[align=center]{\varchD @ CH4\\ \SI{5}{\A}/div \\ RMS: \SI{6.33}{\A} \\ Mean: \SI{6.11}{\A} }
