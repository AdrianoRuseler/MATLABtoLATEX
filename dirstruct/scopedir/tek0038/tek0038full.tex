...
\addplot[solid,ch1color]table[x=time,y=ch1,col sep=comma]{tek0038.csv}; % Add plot data
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch1color}]0:{}}] at (axis cs:-5,-3.42){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]-28:{CH1}}] at (axis cs:1.9009,-3.8192){}; % Print curve tip
\addlegendentry[align=center]{\varchA @ CH1\\ \SI{500}{\V}/div}

% Arrows and labels for channel ch2
\addplot[solid,ch2color]table[x=time,y=ch2,col sep=comma]{tek0038.csv}; % Add plot data
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch2color}]0:{}}] at (axis cs:-5,0.06){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]-31:{CH2}}] at (axis cs:1.8318,-0.37901){}; % Print curve tip
\addlegendentry[align=center]{\varchB @ CH2\\ \SI{500}{\V}/div}

% Arrows and labels for channel ch3
\addplot[solid,ch3color]table[x=time,y=ch3,col sep=comma]{tek0038.csv}; % Add plot data
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch3color}]0:{}}] at (axis cs:-5,-1.78){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]-29:{CH3}}] at (axis cs:1.8548,-2.1283){}; % Print curve tip
\addlegendentry[align=center]{\varchC @ CH3\\ \SI{500}{\V}/div}

% Arrows and labels for channel math
\addplot[solid,mathcolor]table[x=time,y=math,col sep=comma]{tek0038.csv}; % Add plot data
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,mathcolor}]0:{}}] at (axis cs:-5,2.34){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]44:{MATH}}] at (axis cs:3.1221,3.5277){}; % Print curve tip
\addlegendentry[align=center]{\varchD @ MATH\\ \SI{1000}{\V}/div}
      \end{axis}   
