...
\addplot[solid,ch1color]table[x=time,y=ch1,col sep=comma]{tek0047ch1.csv};
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch1color}]0:{}}] at (axis cs:-5,-3.68){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]4:{CH1}}] at (axis cs:0.080645,-3.207){}; % Print curve tip
\addlegendentry[align=center]{$CH1$ @ CH1\\ \SI{500}{\V}/div\\RMS: \SI{277.1089}{\V}}

% Arrows and labels for channel ch2
\addplot[solid,ch2color]table[x=time,y=ch2,col sep=comma]{tek0047ch2.csv};
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch2color}]0:{}}] at (axis cs:-5,-0.22){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]7:{CH2}}] at (axis cs:0.10369,0.087464){}; % Print curve tip
\addlegendentry[align=center]{$CH2$ @ CH2\\ \SI{500}{\V}/div\\RMS: \SI{271.1974}{\V}}

% Arrows and labels for channel ch3
\addplot[solid,ch3color]table[x=time,y=ch3,col sep=comma]{tek0047ch3.csv};
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,ch3color}]0:{}}] at (axis cs:-5,-2.02){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]0:{CH3}}] at (axis cs:0.080645,-1.6327){}; % Print curve tip
\addlegendentry[align=center]{$CH3$ @ CH3\\ \SI{500}{\V}/div\\RMS: \SI{272.9279}{\V}}

% Arrows and labels for channel math
\addplot[solid,mathcolor]table[x=time,y=math,col sep=comma]{tek0047math.csv};
\node[coordinate,pin={[pin distance=\refdist,pin edge={stealth-,semithick,mathcolor}]0:{}}] at (axis cs:-5,2.58){}; % Print ref arrow
\node[coordinate,pin={[pin distance=\tipdist,pin edge={stealth-,semithick,black}]148:{MATH}}] at (axis cs:-1.6014,3.586){}; % Print curve tip
\addlegendentry[align=center]{$MATH$ @ MATH\\ \SI{200}{\V}/div}
      \end{axis}   
