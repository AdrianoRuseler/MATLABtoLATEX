...
\definecolor{c0color}{HTML}{002d3d} 
...
xtick = {0,60,180,...,1000},xmin=-60,ymin=0,ymax=8,
title={Fundamental (\SI{60}{\hertz}) = \SI{310.2905}{};  THD: \SI{7.6653}{};},
xlabel=Frequ\^encia (Hz),ylabel=Magnitude (\% da Fundamental),
] % End of axis configurations
\addplot[nodes near coords,fill,c0color]table[x=freq,y=magperfund,col sep=comma]{PSIMdataex01Vc.csv}; % Add plot data
\addlegendentry{Vc};
    \end{groupplot}
  \end{tikzpicture}
