...
\begin{document}
  ...
  \begin{groupplot}[group style={group size= 1 by 2, vertical sep=0.2cm,  horizontal sep=1cm},ylabel absolute]
      ...
      \addplot[solid,line width=1pt,c2color]table[x=freq,y=mag,col sep=comma]{bode.csv};
      \addlegendentry{Mag};
      
      
      \nextgroupplot[xmode=log,ymode=normal,height=\axisheight,width=\axiswidth,grid=major,
      xmin=1, xmax=10,ymin=-181.3500, ymax=-43.6500,minor tick num=5,xtickten = {0,...,10},xminorgrids=true,
      xlabel=Frequency (rad/s),ylabel=Phase (deg), % No xticks here
    ]
	\addplot[solid,line width=1pt,c2color]table[x=freq,y=phase,col sep=comma]{bode.csv};
